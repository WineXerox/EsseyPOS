...
echo '<h4> รายงานสต๊อกสินค้า-เครื่องดื่ม </h4>';
echo ' <table id="example10" class="table table-bordered table-striped">';
  echo "<thead>";
    echo "<tr class='danger'>
      ...
      <th width='10%'><center>ยอดสต็อกสินค้า</center></th>
    </tr>";
  echo "</thead>";
  ...
  echo "<tr>";
    ...
    echo "<td>";
    echo"<b>" .$row["p_name"]."</b>"."<br>".$row["p_flavour"];echo "</td> ";
    echo "<td>";
        $pid = $row['p_id'];
        $query2 = "
    ...
    echo "<td align='center'><b>" .$row["qtotal"] ."  " .$row["p_unit"] . " / ".$row["p_stotal"]."</b></td>";
  echo "</tr>";
  }
echo "</table>";
mysqli_close($con);
