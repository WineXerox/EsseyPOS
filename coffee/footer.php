	<!-- start footer Area -->		
			<footer class="footer-area section-gap" id="hd">
				<div class="container">
					<div class="row">
...
<!-- 								<h6>Newsletter</h6>
			...
			<script src="https://cdnjs.cloudflare.com/ajax/libs/popper.theme/js/1.12.9/umd/popper.min.js" integrity="sha384-ApNbgh9B+Y1QKtv3Rn7W3mgPxhU9K/ScQsAP7hUibX39j7fakFPskvXusvfa0b4Q" crossorigin="anonymous"></script>
